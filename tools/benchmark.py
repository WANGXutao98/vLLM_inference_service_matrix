...
def run_vllm(
    ...
    print("output",outputs[0].outputs[0])
...
def main(args: argparse.Namespace):
    ...
    print(f"total input tokens {total_input_tokens/elapsed_time:.2f} tokens/s")
    print(f"total output tokens {total_output_tokens/elapsed_time:.2f} tokens/s")
